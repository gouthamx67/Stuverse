...
const Signup = () => {
    ...
    return (
        <div className="page-enter" style={{
            ...
            alignItems: 'center',
            minHeight: '100vh',
            background: 'radial-gradient(circle at bottom left, #312e81, #0f172a)'
        }}>
            <div className="glass-panel" style={{ width: '100%', maxWidth: '450px', padding: '2rem' }}>
                <h2 className="gradient-text" style={{ fontSize: '2rem', fontWeight: 'bold', marginBottom: '0.5rem', textAlign: 'center' }}>
                    Join Stuverse
                </h2>
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div style={{ marginBottom: '1rem', position: 'relative' }}>
                        <Building2 size={20} color="#94a3b8" style={{ position: 'absolute', top: '12px', left: '12px' }} />
                        <input
                            type="text"
                            name="university"
